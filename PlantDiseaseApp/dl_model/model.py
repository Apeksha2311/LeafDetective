...
labels = json.load(open('PlantDiseaseApp\dl_model\plant_classes.json'))
...
def load_model():
     ...
     model.load_params(f_params='PlantDiseaseApp/dl_model/model_params.pt',
                       f_optimizer='PlantDiseaseApp/dl_model/model_optimizer.pt',
                       f_history='PlantDiseaseApp/dl_model/model_history.json')
